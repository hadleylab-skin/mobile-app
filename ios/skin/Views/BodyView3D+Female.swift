...
extension BodyView3D
{
    internal func setupFemale()
    {
        ...
        let bodyConfig = BodyCameraMotionConfig(center: bodyCenter, minR: 5, maxR: 25, r: 20)
        let headConfig = HeadCameraMotionConfig(center: headCenter, minR: 3, maxR: 8, r: 5)
